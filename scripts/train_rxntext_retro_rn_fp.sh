...
MODEL_DIR=output/retro_fp_b512_ep400
MASTER_PORT=$(shuf -n 1 -i 10000-65535)

#python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port $MASTER_PORT -m tevatron.driver.train_custom_encoder \
